      ...
      <div className="home4-blog-section mb-120">
        <div className="container">
          ...
          <div className="row g-lg-4 gy-5">
              ...
              <div className="blog-card">
                <div className="blog-card-img-wrap">
                  <Link href="/blog/blog-details" className="card-img">
                    <img src="/assets/img/home4/blog-card-img1.jpg" alt="" />
                  </Link>
            ...
            <div className="col-lg-4 col-md-6 pt-15 pb-15">
              <div className="blog-card">
                <div className="blog-card-img-wrap">
                  <Link href="/blog/blog-details" className="card-img">
                    <img src="/assets/img/home4/blog-card-img2.jpg" alt="" />
                  </Link>
                  <Link href="/blog" className="date">
                    <span>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-card">
                <div className="blog-card-img-wrap">
                  <Link href="/blog/blog-details" className="card-img">
                    <img src="/assets/img/home4/blog-card-img3.jpg" alt="" />
                  </Link>
                  <Link href="/blog" className="date">
                    <span>
